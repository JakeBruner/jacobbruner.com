...
<footer>
  <div class="bg-white bottom-0 left-0 right-0 py-10 px-10">
    <div class="flex flex-row">
      <div class="basis-1/3 px-7">
        <h4 class="pb-4">Website</h4>
      ...
      <div class="basis-1/3 px-7">
        <h4 class="pb-4">Links</h4>
        <p class="grid grid-cols-2 leading-relaxed">
          {#each nav as item}
            <a class="hover:text-stone-900" href={item.path}>{item.title} </a>
          {/each}
        </p>
      </div>
      <div class="basis-1/3 px-7">
        <h4 class="pb-4">Contact Information</h4>
        <p class="leading-relaxed">
          New York City <br />
          United States <br />
    ...
    <div class="text-center pt-14 pb-5">
      <small class="block text-[15px] text-stone-700">
