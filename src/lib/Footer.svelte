...
<footer class="bg-white dark:bg-zinc-900">
  <div class="w-full insex-x-0 bottom-0 left-0 right-0 py-10">
    <div class="md:container md:mx-auto xl:px-40 lg:px-28">
      <div class="flex sm:flex-row flex-col gap-y-6">
        ...
        <div class="basis-[37.5%] px-9 xl:px-16">
          ...
          <p
            class="flex md:grid md:grid-cols-2 flex-col leading-relaxed font-light"
          >
            {#each nav as item}
              <a
      ...
      <div class="text-center pt-14 pb-5">
        <small
          class="block text-[17px] italic text-stone-700 dark:text-zinc-400"
        >
