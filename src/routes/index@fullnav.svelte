...
<section class="">
  ...
  >
    <h1
      class="bg-white_translucent dark:bg-zinc-900/70 text-[53px] text-zinc-700 dark:text-zinc-300 font-light pb-[13px] pt-[17px] px-2 my-4 fadeInDown"
    >
      Learning as a Hobby
      <!-- Learning is a skill -->
    </h1>
...
<section class="container my-24 px-6 mx-auto">
  <div class="flex flex-wrap lg:px-20 px-30 basis-auto justify-center content-center space-x-12">
    <div
      class="grow-0 shrink-0 lg:w-4/12 w-10/12 shadow-xl dark:shadow-zinc-700/50 p-7 rounded-md bg-[url('/images/schoolphoto2.jpg')] bg-cover bg-top lg:h-[500px] sm:h-[700px] h-[500px] lg:w-min-full bg-clip-content lg:m-0 m-12"
