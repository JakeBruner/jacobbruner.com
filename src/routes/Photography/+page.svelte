<section class="p-4 w-full md:w-2/3 mx-auto">
  <h1 class="py-4 border-b border-b-zinc-200  dark:border-b-zinc-700 pb-6">Photography</h1>
  <div class="w-full mx-auto pt-5 text-center content-center">
    <a href="/Photography/Kilimanjaro">
      <div class="flex w-full group  items-center text-center justify-center shadow-lg">
        ...
        <img
          alt="kilimanjaro"
          class="static block object-cover object-center w-full h-full rounded-lg shadow-sm group-hover:brightness-90 group-hover:contrast-[90%] group-hover:scale-[100.5%]  transition-all ease-out "
